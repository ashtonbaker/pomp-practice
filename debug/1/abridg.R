...
system('echo \"Starting initial pfilter\" ')
...
system('echo \"Finished initial pfilter\" ')
...
system('echo \"Starting local box search\" ')
...
system('echo \"Finished local box search\" ')

system('echo \"Starting lik_local\" ')
...
system('echo \"Finished lik_local\" ')
...
# system('echo \"Starting global search\" ')
#
...
# write.csv(results,file="./output/model_params.csv",row.names=FALSE)
#
# system('echo \"Finished global search\" ')
