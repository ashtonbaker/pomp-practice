...
double rate[2], etrans[2 * ESTAGES], ltrans[2 * LSTAGES], ptrans[2 * ASTAGES], adeath;
...
lik =   log(pnorm(L_obs + 0.5, L_tot, meas_sd, 1, 0) - pnorm(L_obs - 0.5, L_tot, meas_sd, 1, 0)) +
        ...
        log(pnorm(A     + 0.5, A,     meas_sd, 1, 0) - pnorm(A     - 0.5, A,     meas_sd, 1, 0));
